...
%The similarities of this expression with the Schr\"odinger's equation are surprising. However, there is nothing quantumly treated in this classical approach. In fact, these similarities are due to the complex treatment of the spinorial canonical transformation, which could have been done  less compactly by taking the real and imaginary parts as different canonical variables.\\%
