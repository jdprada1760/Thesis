...
Then we deduce that $\mathbb{J}$ is a canonical angular momentum. It is not difficult to see that this is in fact the Poincar\'e vector in equation \refeq{eq:poincarevec}, and furthermore, that this is the canonical angular moment associated with the current canonical variables:
